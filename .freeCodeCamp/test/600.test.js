...
describe('tests', () => {
  it('should pass', async () => {
    ...
    assert(correctFlags && filteredCommand[0] === 'grep' && filteredCommand[1].pattern === 'meow[a-z]*' && filteredCommand[2] === 'kitty_ipsum_1.txt' && filteredCommand[3].op === '|' && filteredCommand[4] === 'wc' && (filteredCommand[5] === '-l' || filteredCommand[5] === '--lines') && filteredCommand[6].op === '>>' && filteredCommand[7] === 'kitty_info.txt' && /7/.test(fileContents));
  });
});*/
