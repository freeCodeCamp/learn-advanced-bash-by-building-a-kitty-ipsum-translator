...
describe('You', () => {
  it('should enter the suggested command', async () => {
    ...
    assert(correctFlag1 && correctFlag2 && filteredCommand[0] === 'grep' && (filteredCommand[1] === 'cat[a-z]*' || filteredCommand[1].pattern === 'cat[a-z]*') && filteredCommand[2] === 'kitty_ipsum_1.txt' && filteredCommand[3].op === '|' && filteredCommand[4] === 'sed' && filteredCommand[5] === 's/([0-9]+).*/\\1/' && filteredCommand[6].op === '>>' && filteredCommand[7] === 'kitty_info.txt');
  });
});
