...
describe('You', () => {
  it('should enter the suggested command', async () => {
    ...
    const correctCommand = lastCommand[0] === 'echo' && lastCommand[1] === '-e' && lastCommand[2] === '\\nNumber of times meow or meowzer appears:' && lastCommand[3].op === '>>' && lastCommand[4] === 'kitty_info.txt';

    assert(correctCommand && fileContents.match(/Number of times meow or meowzer appears:/g).length >= 2);
  });
});
